...
*/
class DirectionManager extends StateNotifier<SwipeDirection?> {
  DirectionManager() : super(null);
...
final directionManager =
StateNotifierProvider<DirectionManager, SwipeDirection?>((ref) {
